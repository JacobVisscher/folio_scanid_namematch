...
def run(inum, toegangsnummer, folder_path, path_to_files):
    ...
    check_folder = os.path.join(folder_path, "output_step0")

    inputfolder = os.path.join(folder_path, "output_step1")

    outputfolder = os.path.join(folder_path, "output_step2")
    ...
    path_namelist = os.path.join(check_folder, name_list_filename)
    ...
    if os.path.isfile(path_namelist):
        ...
        reader = csv.reader(
            open("/" + outputfolder + "/" + output_filename), delimiter=" "
        )
