...
archivelink_incomplete = "NL-HaNA/2.13.04/"
...
target_file = "NT00297_PERSOON.csv"
target_file = os.path.join(inputfolder, "NT00297_PERSOON.csv")
print(target_file)
...
target_file = os.path.join(inputfolder, "NT00396_STAMBOEKREGISTRATIES.csv")
print(target_file)
